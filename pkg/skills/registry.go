...
type SkillRegistry interface {
	...
	// DownloadAndInstall fetches, downloads and installs the skill to targetDir.
...
// SearchAll fans out the query to all registries concurrently and merges results.
...
// sortByScoreDesc sorts SearchResults by Score descending.
