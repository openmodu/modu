...
// SearchCache provides lightweight caching for skill search results.
// Uses trigram-based similarity to match similar queries to cached results,
...
// (either exact or similar match above threshold).
...
// buildTrigrams generates sorted, deduplicated uint32 hashes of trigrams.
