...
func (s *Store) DailyUsage(ctx context.Context, filter SummaryFilter) ([]TimeBucketRow, error) {
	query := `
SELECT
	local_date,
	app,
...
WHERE 1=1`
	...
	query += `
GROUP BY local_date, app
ORDER BY local_date DESC, app`
