...
func hubMailboxTools(hub *mailbox.Hub, agentID string) []types.Tool {
	return []types.Tool{
...
func (t *hubDelegateTool) Execute(ctx context.Context, _ string, args map[string]any, _ types.ToolUpdateCallback) (types.ToolResult, error) {
	to, _ := args["to"].(string)
...
func (t *hubReplyTool) Execute(_ context.Context, _ string, args map[string]any, _ types.ToolUpdateCallback) (types.ToolResult, error) {
	to, _ := args["to"].(string)
	taskID, _ := args["task_id"].(string)
...
func (t *hubPostTool) Execute(_ context.Context, _ string, args map[string]any, _ types.ToolUpdateCallback) (types.ToolResult, error) {
	taskID, _ := args["task_id"].(string)
	text, _ := args["text"].(string)
...
func (t *hubPinTool) Execute(_ context.Context, _ string, args map[string]any, _ types.ToolUpdateCallback) (types.ToolResult, error) {
	taskID, _ := args["task_id"].(string)
...
func (t *hubCompleteTool) Execute(_ context.Context, _ string, args map[string]any, _ types.ToolUpdateCallback) (types.ToolResult, error) {
	taskID, _ := args["task_id"].(string)
	filePath, _ := args["file_path"].(string)
...
func hubText(s string) types.ToolResult {
